...
function looksLikeGibberish(text) {
  ...
  const REAL = /^(a|an|the|i|is|it|in|on|to|of|or|my|me|do|no|hi|ok|at|so|if|we|be|he|us|up|as|by|go|am|has|are|was|and|but|for|not|you|how|can|all|get|got|its|our|out|had|who|new|now|may|any|say|old|her|him|his|she|too|two|one|use|way|set|end|own|off|try|let|big|day|see|yet|ask|did|fee|sir|yes|what|when|with|this|that|from|have|will|your|more|each|they|been|like|long|make|many|some|than|them|then|time|very|just|know|take|come|over|also|back|much|most|only|into|here|last|made|done|must|give|need|want|help|tell|show|good|work|look|year|find|does|best|keep|same|offer|about|which|after|first|where|check|math|maths|phd|mphil|mscs|dept|course|roadmap|seat|wala|wali|kya|hai|hain|mein|kar|kaise|kitni|kitna|ye|wo|nahi|aur|mera|meri|apna|kab|kahan|bhi|koi|sab|se|ke|ko|ka|ki|par|ho|hoga|hogi|dein|aap|tum|yeh|kuch|abhi|acha|theek|lgu|bscs|bsse|bsit|cmai|bba|mba|fee|apply|admission|program|degree|test|marks|scholarship|merit|criteria|campus|hostel|hec|transport|bus|document|deadline|schedule|semester|credit|science|engineering|computer|psychology|criminology|english|urdu|chemistry|physics|nursing|pharmd|dpt|llb|last|date|when|next|entry|structure|available|offered|required|submit|eligible|minimum)\b/i;
